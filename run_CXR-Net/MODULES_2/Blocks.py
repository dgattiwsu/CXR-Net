...
from tensorflow.keras.layers import ConvLSTM2D, LeakyReLU, Multiply, GlobalAveragePooling2D
...
def stem_split_3k(x, filters, mode="conc",
    ...
    res2 = SeparableConv2D(res_filters, kernel_size=kernel_size_2,
                           ...
                           pointwise_initializer=he_normal(seed=5), 
                           bias_initializer='zeros',
                           kernel_regularizer=kernel_regularizer)(x2)      
...
def residual_block_split_3k(x, filters, mode="conc", 
    ...
    x1 = SeparableConv2D(res_filters, kernel_size=kernel_size_1,
                         ...
                         pointwise_initializer=he_normal(seed=5), 
                         bias_initializer='zeros',
                         kernel_regularizer=kernel_regularizer)(x0)
    x1 = BatchNormalization()(x1)
    x1 = LeakyReLU(alpha=0.1)(x1)
...
def residual_convLSTM2D_block(x,filters,num_class,rd=0.1,rs=True):       
...
def soft_shrink_block(x,num_class):
...
def null_shrink_block(x,num_class):
