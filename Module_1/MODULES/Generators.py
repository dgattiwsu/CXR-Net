...
# def add_random_noise(x,WIDTH,HEIGHT,CHANNELS):
...
#     row,col,ch = WIDTH,HEIGHT,CHANNELS
...
#     elif np.random.random() > 1/4 and <= 2/4:
#         noise_typ = "s&p"
#         s_vs_p = 0.5
#         amount = 0.004
#         out = np.copy(x)
...
#     elif np.random.random() > 2/4 and <= 3/4:
#         noise_typ = "poisson":
